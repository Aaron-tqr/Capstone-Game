...
const STORY_END_SCENE: String = "res://scenes/Story/StoryCompleteScene.tscn"
...
const INTRO_END_TITLE: String = "NEVER ENDING FEELINGS"
const INTRO_START_BLUR: String = "ending start blur.png"
...
var _beats: Array[Dictionary] = [
	{
		"frame_path": "EndFrame_01.png",
		"speaker": "",
		"text": "The long day was finally over. Jimm sat in his cozy room and thought about everything that happened.",
		"plain_story": true,
	},
	{
		"frame_path": "EndFrame_01.png",
		"speaker": "Jimm",
		"text": "What a busy day... I felt so many different things.",
		"plain_story": false,
	},
	{
		"frame_path": "EndFrame_02.png",
		"show_emotions": true,
		"emotion_float": true,
		"speaker": "Joy",
		"text": "You did it, Jimm! You found your smile even when things were tough!",
		"plain_story": false,
	},
	{
		"frame_path": "EndFrame_02.png",
		...
		"emotion_float": true,
		"speaker": "Sadness",
		"text": "It's okay that you felt blue. Every heart needs a little rain sometimes.",
		"plain_story": false,
	},
	{
		"frame_path": "EndFrame_02.png",
		...
		"emotion_float": true,
		"speaker": "Anger",
		"text": "You were very brave to stand up for yourself today!",
		"plain_story": false,
	},
	{
		"frame_path": "EndFrame_02.png",
		...
		"emotion_float": true,
		"speaker": "Disgust",
		"text": "And you were smart to stay away from those yucky, sticky messes!",
		"plain_story": false,
	},
	{
		"frame_path": "EndFrame_02.png",
		...
		"emotion_float": true,
		"speaker": "Fear",
		"text": "Whenever the world feels too big, remember that we are always here for you.",
		"plain_story": false,
	},
	{
		"frame_path": "EndFrame_02.png",
		...
		"emotion_float": true,
		"speaker": "Jimm",
		"text": "Thank you, everyone. I learned that all of my feelings are my friends.",
		"plain_story": false,
	},
	{
		"frame_path": "EndFrame_03.png",
		"speaker": "",
		"text": "Jimm closed his eyes, feeling safe and calm. No matter what tomorrow brought, he was ready.",
		"plain_story": true,
	},
	{
		"frame_path": "EndFrame_03.png",
		"speaker": "Jimm",
		"text": "Goodnight, feelings. See you tomorrow.",
		"plain_story": false,
	},
	{
		"frame_path": "ending end blur.png",
		"speaker": "",
		"text": "The feelings never truly end. They guide us, teach us, and help us grow every day.",
		"plain_story": true,
	},
]
...
func _ready() -> void:
	...
	top_title.add_theme_color_override("font_color", Color(1.0, 0.62, 0.18, 1.0))
	intro_title.add_theme_color_override("font_color", Color(1.0, 0.62, 0.18, 1.0))
	...
	if not skip_intro_once:
		await _play_tap_card(INTRO_START_BLUR, INTRO_END_TITLE, "TAP ANYWHERE TO CONTINUE", false)
		_active_frame = -1
...
func _ensure_question_hud() -> void:
	...
	var coin_holder: HBoxContainer = HBoxContainer.new()
	coin_holder.name = "Coins"
	coin_holder.position = Vector2(182, 20)
	coin_holder.add_theme_constant_override("separation", 6)
	question_hud.add_child(coin_holder)

	var coin_icon_rect: TextureRect = TextureRect.new()
	coin_icon_rect.texture = load("res://assets/UI/Icons/Icon_Small_Coin.png") as Texture2D
	coin_icon_rect.custom_minimum_size = Vector2(28, 28)
	coin_icon_rect.expand_mode = TextureRect.EXPAND_IGNORE_SIZE
	coin_icon_rect.stretch_mode = TextureRect.STRETCH_KEEP_ASPECT_CENTERED
	coin_holder.add_child(coin_icon_rect)

	question_coin_label = Label.new()
	question_coin_label.text = str(GameState.coins)
	question_coin_label.add_theme_color_override("font_color", Color(1, 0.95, 0.35, 1))
	question_coin_label.add_theme_color_override("font_outline_color", Color(0, 0, 0, 1))
	question_coin_label.add_theme_constant_override("outline_size", 6)
	question_coin_label.add_theme_font_size_override("font_size", 26)
	coin_holder.add_child(question_coin_label)

func _set_question_hud_visible(visible: bool) -> void:
	if question_hud != null:
		question_hud.visible = visible
	if visible and question_coin_label != null:
		question_coin_label.text = str(GameState.coins)
