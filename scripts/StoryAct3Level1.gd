...
const FRAME_FOLDER: String = "res://assets/story/act3"
...
const INTRO_ACT3_TITLE: String = "ACT 3: THE SCHOOL OF COURAGE"
const INTRO_START_BLUR: String = "act3 start blur.png"
...
const SPEAKER_PORTRAITS: Dictionary = {
	...
	"Teacher": "res://assets/story/act3/CharacterFace/Teacher.png",
	"Friend": "res://assets/story/act2/CharacterFace/Friend.png",
	"Big Kid": "res://assets/story/act3/CharacterFace/Big Kid.png",
	"Auntie": "res://assets/story/act3/CharacterFace/Auntie.png",
}

const JIMM_FACE_BY_EMOTION: Dictionary = {
	"Disgust": "res://assets/story/act3/JimmFace/JimmFace1.png",
	"Anger": "res://assets/story/act3/JimmFace/JimmFace2.png",
	"Fear": "res://assets/story/act3/JimmFace/JimmFace3.png",
}
...
var _beats: Array[Dictionary] = [
	{
		"frame": 1,
		"speaker": "",
		"text": "Monday morning arrived. Jimm hurried to school, excited to show his teacher his new drawing.",
		"plain_story": true,
	},
	{
		"frame": 1,
		"speaker": "Jimm",
		"text": "I can't wait to sit down and start my schoolwork!",
		"plain_story": false,
	},
	{
		"frame": 2,
		"speaker": "",
		"text": "But when Jimm reached his desk, he saw something that should not have been there.",
		"plain_story": true,
	},
	{
		"frame": 2,
		"speaker": "Jimm",
		"text": "Oh no... what happened to my chair?",
		"plain_story": false,
	},
	{
		"frame": 3,
		"speaker": "Jimm",
		"text": "Ew! Someone spilled juice and left crumbs all over my chair. It smells sour!",
		"plain_story": false,
	},
	{
		"frame": 4,
		"question_delayed": true,
		"speaker": "Jimm",
		"text": "Yuck... this chair is so sticky and gross!",
		"plain_story": false,
		"is_question": true,
		"correct_emotion": "Disgust",
		"question": "Jimm thinks the sticky chair is gross. What is he feeling?",
		"feedback": {
			"Disgust": "Correct! Jimm feels Disgust because the sticky chair is messy, smelly, and gross.",
			"Joy": "Not this one. Jimm is not happy about the mess.",
			"Sadness": "He is reacting to something gross, not mostly feeling sad.",
			"Anger": "He says \"ew\", so the strongest feeling here is Disgust.",
			"Fear": "He is not scared of danger here. He is grossed out."
		},
		"dim": 0.34,
	},
	{
		"frame": 5,
		"speaker": "",
		"text": "Later, the recess bell rang, and all the students lined up to go outside and play.",
		"plain_story": true,
	},
	{
		"frame": 5,
		"speaker": "Jimm",
		"text": "I hope I get to the swings first today!",
		"plain_story": false,
	},
	{
		"frame": 6,
		"speaker": "Big Kid",
		"text": "Move it! I'm going first!",
		"plain_story": false,
	},
	{
		"frame": 6,
		"speaker": "Jimm",
		"text": "Hey! I was waiting in line! That's not fair at all!",
		"plain_story": false,
	},
	{
		"frame": 7,
		"question_delayed": true,
		"speaker": "Jimm",
		"text": "That was really mean. I feel so mad right now!",
		"plain_story": false,
		"is_question": true,
		"correct_emotion": "Anger",
		"question": "Jimm is upset because the Big Kid was mean. Which emotion is this?",
		"feedback": {
			"Anger": "That's right. Jimm is feeling Anger because someone treated him unfairly.",
			"Joy": "No, Jimm is not cheerful right now.",
			"Sadness": "He is upset, but his reaction is more angry than sad.",
			"Disgust": "This is not about something gross. Jimm is mad at unfair behavior.",
			"Fear": "He is not scared in this moment. He is frustrated and angry."
		},
		"dim": 0.34,
	},
	{
		"frame": 8,
		"speaker": "",
		"text": "After class, Jimm stayed behind to finish his drawing. When he stepped out, the hallway was very quiet.",
		"plain_story": true,
	},
	{
		"frame": 8,
		"speaker": "Jimm",
		"text": "Wait... where did everyone go? It's so quiet out here.",
		"plain_story": false,
	},
	{
		"frame": 9,
		"speaker": "Jimm",
		"text": "I don't like how quiet it is. Is anyone still here?",
		"plain_story": false,
	},
	{
		"frame": 10,
		"question_delayed": true,
		"speaker": "Jimm",
		"text": "It's so dark and quiet... I feel scared.",
		"plain_story": false,
		"is_question": true,
		"correct_emotion": "Fear",
		"question": "Jimm is all alone in the quiet, dark hallway. What is he feeling?",
		"feedback": {
			"Fear": "Correct. Jimm feels Fear because the dark, empty hallway makes him nervous.",
			"Joy": "Not now. He is not feeling playful in this empty hallway.",
			"Sadness": "He may be uncomfortable, but this scene shows fear the most.",
			"Anger": "He is not mad at anyone in this moment.",
			"Disgust": "Nothing gross is happening here. Jimm is scared."
		},
		"dim": 0.34,
	},
	{
		"frame": 11,
		"speaker": "",
		"text": "Suddenly, a door opened! Jimm wasn't alone after all.",
		"plain_story": true,
	},
	{
		"frame": 11,
		"speaker": "Teacher",
		"text": "Jimm? There you are! Come along, your Auntie is here to pick you up.",
		"plain_story": false,
	},
	{
		"frame": 11,
		"speaker": "Jimm",
		"text": "Teacher! I'm so glad you're here. I was a little worried!",
		"plain_story": false,
	},
	{
		"frame": 12,
	...
	},
	{
		"frame": 13,
		"speaker": "",
		"text": "The teacher walked with Jimm down the hallway toward the big exit doors, keeping him safe.",
		"plain_story": true,
	},
	{
		"frame": 14,
		"speaker": "",
		"text": "Outside the school gate, Jimm's Auntie was waiting to pick him up.",
		"plain_story": true,
	},
	{
		"frame": 14,
		"speaker": "Jimm",
		"text": "Hi Auntie! I have so much to tell you about my day!",
		"plain_story": false,
	},
	{
		"frame": 14,
		"speaker": "Auntie",
		"text": "You can tell me more on our way home.",
		"plain_story": false,
	},
	{
		"frame_path": "act3 end blur.png",
		"speaker": "",
		"text": "Jimm learned that help is always nearby when things feel scary. Act 3 complete!",
		"plain_story": true,
	},
]
...
func _ready() -> void:
	...
	top_title.add_theme_color_override("font_color", Color(1.0, 0.2, 0.2, 1.0))
	intro_title.add_theme_color_override("font_color", Color(1.0, 0.2, 0.2, 1.0))
	...
	if not skip_intro_once:
		await _play_tap_card(INTRO_START_BLUR, INTRO_ACT3_TITLE, "TAP ANYWHERE TO CONTINUE", false)
		_active_frame = -1
...
func _show_current_beat() -> void:
	...
	STORY_VOICE_MANAGER.play_story_line(3, speaker, line_text, plain, speaker_line_index)
	if next_button != null:
...
func _enter_question_state(beat: Dictionary) -> void:
	...
	STORY_VOICE_MANAGER.play_story_question(3, String(beat.get("question", "")), _question_index)
...
func _on_emotion_selected(emotion_name: String) -> void:
	...
	STORY_VOICE_MANAGER.play_emotion_question_feedback(3, emotion_name, _question_index)
...
func _transition_to_frame_path(path: String) -> void:
	if not ResourceLoader.exists(path):
		push_warning("StoryAct3Level1: missing frame: %s" % path)
		return
